...
(function() {
  var Date, cheerio, real, superagent;
  ...
  real.prototype = {
    getData: function(response) {
      return superagent.get(this.url).end(function(err, res) {
        var $, aTop, all, bTop, bangdan, d, dTop, films, footer, grade, img, imgs, pchart, releaselist, tnews;
        if (err) {
          console.error(err);
        } else {
          all = [];
        ...
        aTop = [];
        $('ul.ul_jjsy').first().find('li').each(function() {
          console.log('================================aTop');
        ...
        dTop = [];
        $('ul.ul_jjsy').eq(1).find('li').each(function() {
          console.log('================================aTop');
          console.log($(this).find('a img').attr('title'));
          return dTop.push({
            title: $(this).find('a img').attr('title').trim(),
        ...
        bTop = [];
        $('ul.ul_jjsy').eq(2).find('li').each(function() {
          console.log('================================bTop');
          console.log($(this).find('a img').attr('title'));
          return bTop.push({
            title: $(this).find('a img').attr('title').trim(),
